...
export const InstanceDriverEvent = memoizeOne(() => z.discriminatedUnion('type', [z.object({connected: z.boolean(), type: z.literal("connected"), }), z.object({capturedAt: z.coerce.date(), channel: z.number().int(), instanceId: z.string(), reportId: z.string(), type: z.literal("report"), value: z.number(), }), ]));
...
export const WsCommand = memoizeOne(() => z.discriminatedUnion('type', [z.object({instance_id: z.string(), power: z.lazy(InstancePowerControl), type: z.literal("setInstancePowerControl"), }), z.object({instance_id: z.string(), play: z.lazy(InstancePlayControl), type: z.literal("setInstancePlayControl"), }), z.object({changes: z.array(z.lazy(SetInstanceParameter)), instanceId: z.string(), type: z.literal("setInstanceParameters"), }), z.object({instance_id: z.string(), type: z.literal("subscribeToInstanceEvents"), }), z.object({instance_id: z.string(), type: z.literal("unsubscribeFromInstanceEvents"), }), ]));
export type WsCommand = z.infer<ReturnType<typeof WsCommand>>;

export const WsEvent = memoizeOne(() => z.discriminatedUnion('type', [z.object({requestId: z.string(), success: z.boolean(), type: z.literal("setInstancePowerControl"), }), z.object({requestId: z.string(), success: z.boolean(), type: z.literal("setInstancePlayControl"), }), z.object({requestId: z.string(), response: z.lazy(SetInstanceParameterResponse), type: z.literal("setInstanceParameters"), }), z.object({event: z.lazy(InstanceDriverEvent), instanceId: z.string(), type: z.literal("instanceDriverEvent"), }), z.object({requestId: z.string(), success: z.boolean(), type: z.literal("subscribeToInstanceEvents"), }), z.object({requestId: z.string(), success: z.boolean(), type: z.literal("unsubscribeFromInstanceEvents"), }), ]));
export type WsEvent = z.infer<ReturnType<typeof WsEvent>>;

export const WsRequest = memoizeOne(() => z.object({command: z.lazy(WsCommand), requestId: z.string(), }));
