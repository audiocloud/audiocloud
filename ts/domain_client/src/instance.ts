...
export const InstanceSpec = memoizeOne(() =>
  z.object({
    ...
    hostId: z.string(),
    mediaSpec: z.union([z.lazy(InstanceMediaSpec), z.null()]),
...
export const InstanceState = memoizeOne(() =>
  z.object({
    play: z.union([z.lazy(InstancePlayState), z.null()]),
    power: z.union([z.lazy(InstancePowerState), z.null()]),
  })
);
export type InstanceState = z.infer<ReturnType<typeof InstanceState>>;
...
export const SetInstanceParameterRequest = memoizeOne(() =>
  z.object({
    channel: z.number().int(),
    parameter: z.string(),
    value: z.number(),
...
export type SetInstanceParameterRequest = z.infer<
  ReturnType<typeof SetInstanceParameterRequest>
>;

export const SetInstanceParameterResponse = memoizeOne(() =>
  z.enum(["success", "parameterNotFound", "channelNotFound"])
);
...
export const WsDriverEvent = memoizeOne(() =>
  z.discriminatedUnion("type", [
    z.object({
      capturedAt: z.coerce.date(),
      channel: z.number().int(),
...
export const WsDriverRequest = memoizeOne(() =>
  z.object({
    channel: z.number().int(),
    parameter: z.string(),
