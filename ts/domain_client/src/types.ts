...
export const Array_of_SetTaskSetting = memoizeOne(() =>
  z.array(z.lazy(SetTaskSetting))
);
export type Array_of_SetTaskSetting = z.infer<
  ReturnType<typeof Array_of_SetTaskSetting>
>;
...
export const BinaryPosition = memoizeOne(() =>
  z.union([
...
export const Clamp = memoizeOne(() =>
  z.object({ max: z.number(), min: z.number() })
);
export type Clamp = z.infer<ReturnType<typeof Clamp>>;

export const CreateTaskRequest = memoizeOne(() =>
  z.object({
    app: z.string(),
    engine: z.string(),
    from: z.coerce.date(),
    instances: z.record(z.lazy(InstanceAllocationRequest)),
    to: z.coerce.date(),
  })
);
export type CreateTaskRequest = z.infer<ReturnType<typeof CreateTaskRequest>>;

export const CreateTaskResponse = memoizeOne(() =>
  z.discriminatedUnion("type", [
    ...
    z.object({ type: z.literal("overlappingTask") }),
    z.object({ instance_id: z.string(), type: z.literal("noSuchInstance") }),
  ])
);
export type CreateTaskResponse = z.infer<ReturnType<typeof CreateTaskResponse>>;

export const DeleteUserResponse = memoizeOne(() =>
...
export const DesiredTaskPlayState = memoizeOne(() =>
  z.discriminatedUnion("type", [
    ...
    z.object({
      ...
      looping: z.boolean(),
      playId: z.number().int(),
      sinks: z.record(z.lazy(SinkSpec)),
      start: z.number().int(),
...
export const DriverServiceSpec = memoizeOne(() =>
  z.object({ driverId: z.string(), instanceIds: z.array(z.string()) })
);
export type DriverServiceSpec = z.infer<ReturnType<typeof DriverServiceSpec>>;

export const GraphPlaybackError = memoizeOne(() =>
  z.discriminatedUnion("type", [
    z.object({
      error: z.string(),
      sink: z.number().int(),
      type: z.literal("incompatibleSinks"),
    }),
    z.object({
      play_id: z.number().int(),
      type: z.literal("graphAlreadyPlaying"),
    }),
  ])
);
export type GraphPlaybackError = z.infer<ReturnType<typeof GraphPlaybackError>>;

export const GraphPlaybackState = memoizeOne(() =>
  z.discriminatedUnion("type", [
    z.object({ position: z.number().int(), type: z.literal("buffering") }),
    z.object({ position: z.number().int(), type: z.literal("playing") }),
    z.object({ type: z.literal("stopped") }),
  ])
);
export type GraphPlaybackState = z.infer<ReturnType<typeof GraphPlaybackState>>;

export const GraphPlayerEvent = memoizeOne(() =>
  z.discriminatedUnion("type", [
    z.object({ details: z.lazy(GraphPlaybackError), type: z.literal("error") }),
    z.object({
      details: z.object({ state: z.lazy(GraphPlaybackState) }),
      type: z.literal("graphStateChanged"),
    }),
    z.object({
      details: z.object({
        nodes: z.record(z.lazy(NodeInfo)),
        play_id: z.number().int(),
      }),
      type: z.literal("graphNodesPrepared"),
    }),
    z.object({
      details: z.object({
        data: z.array(z.number().int()),
        play_head: z.lazy(PlayHead),
        play_id: z.number().int(),
        sink_id: z.number().int(),
      }),
      type: z.literal("graphSinkCaptured"),
    }),
    z.object({
      details: z.object({
        events: z.array(z.lazy(NodeEvent)),
        node_id: z.lazy(NodeId),
        play_id: z.number().int(),
      }),
      type: z.literal("nodeEvents"),
    }),
  ])
);
export type GraphPlayerEvent = z.infer<ReturnType<typeof GraphPlayerEvent>>;

export const HttpDriverParameter = memoizeOne(() =>
  z.object({
    body: z.union([z.string(), z.null()]),
    headers: z.record(z.string()),
    method: z.lazy(HttpMethod),
    url: z.string(),
  })
);
export type HttpDriverParameter = z.infer<
  ReturnType<typeof HttpDriverParameter>
>;

export const HttpDriverReport = memoizeOne(() =>
  z.object({
    body: z.union([z.string(), z.null()]),
    method: z.lazy(HttpMethod),
    path: z.string(),
    pollTimeMs: z.number().int(),
    response: z.string(),
  })
);
...
export const InstanceDriverConfig = memoizeOne(() =>
  z.discriminatedUnion("type", [
    ...
    z.object({
      baseUrl: z.string(),
      parameters: z.record(z.lazy(HttpDriverParameter)),
      reports: z.record(z.lazy(HttpDriverReport)),
      type: z.literal("HTTP"),
    }),
    z.object({ type: z.literal("SPI") }),
    z.object({ type: z.literal("mock") }),
  ])
);
export type InstanceDriverConfig = z.infer<
  ReturnType<typeof InstanceDriverConfig>
>;
...
export const InstanceDriverReportEvent = memoizeOne(() =>
  z.object({
    capturedAt: z.coerce.date(),
    channel: z.number().int(),
    instanceId: z.string(),
...
export type InstanceDriverReportEvent = z.infer<
  ReturnType<typeof InstanceDriverReportEvent>
>;

export const InstanceFeature = memoizeOne(() =>
  z.enum(["mediaTransport", "midiNoteOnOff", "digitalInputOutput", "routing"])
);
...
export const InstanceModel = memoizeOne(() =>
  z.object({
    audioInputs: z.number().int(),
    audioOutputs: z.number().int(),
    parameters: z.record(z.lazy(ParameterModel)),
    reports: z.record(z.lazy(ReportModel)),
    supports: z.array(z.lazy(InstanceFeature)),
  })
);
...
export const InstancePlayStateTransition = memoizeOne(() =>
  z.enum(["setRewinding", "setIdle", "setBusy", "setPlaying"])
);
export type InstancePlayStateTransition = z.infer<
  ReturnType<typeof InstancePlayStateTransition>
>;
...
export const InstancePowerSpec = memoizeOne(() =>
  z.object({
...
export const InstanceSpec = memoizeOne(() =>
  z.object({
    ...
    model: z.lazy(InstanceModel),
    power: z.union([z.lazy(InstancePowerSpec), z.null()]),
  })
);
export type InstanceSpec = z.infer<ReturnType<typeof InstanceSpec>>;

export const LoginUserRequest = memoizeOne(() =>
  z.object({ id: z.string(), password: z.string() })
);
export type LoginUserRequest = z.infer<ReturnType<typeof LoginUserRequest>>;

export const LoginUserResponse = memoizeOne(() =>
  z.object({ token: z.string() })
);
export type LoginUserResponse = z.infer<ReturnType<typeof LoginUserResponse>>;

export const Map_of_InstanceAllocationRequest = memoizeOne(() =>
  z.record(z.lazy(InstanceAllocationRequest))
);
export type Map_of_InstanceAllocationRequest = z.infer<
  ReturnType<typeof Map_of_InstanceAllocationRequest>
>;

export const MediaDownloadSpec = memoizeOne(() =>
  z.object({ fromUrl: z.string(), sha256: z.string(), size: z.number().int() })
);
export type MediaDownloadSpec = z.infer<ReturnType<typeof MediaDownloadSpec>>;

export const MediaDownloadState = memoizeOne(() =>
  z.object({
    done: z.union([z.lazy(MediaSpec), z.null()]),
...
export const MediaSpec = memoizeOne(() =>
  z.object({ id: z.lazy(MediaId), sha256: z.string() })
);
export type MediaSpec = z.infer<ReturnType<typeof MediaSpec>>;

export const MediaUploadSpec = memoizeOne(() =>
  z.object({ toUrl: z.string() })
);
export type MediaUploadSpec = z.infer<ReturnType<typeof MediaUploadSpec>>;

export const MediaUploadState = memoizeOne(() =>
  z.object({
    error: z.union([z.string(), z.null()]),
    progress: z.number(),
    updatedAt: z.coerce.date(),
...
export const NodeEvent = memoizeOne(() =>
  z.object({
    report: z.object({
      channel: z.number().int(),
      name: z.string(),
...
export const NodeId = memoizeOne(() =>
  z.discriminatedUnion("type", [
    z.object({ id: z.number().int(), type: z.literal("source") }),
    z.object({ id: z.number().int(), type: z.literal("deviceInsert") }),
    z.object({ id: z.number().int(), type: z.literal("virtualInsert") }),
    z.object({ id: z.number().int(), type: z.literal("bus") }),
    z.object({ id: z.number().int(), type: z.literal("deviceSink") }),
    z.object({ id: z.number().int(), type: z.literal("streamingSink") }),
  ])
);
export type NodeId = z.infer<ReturnType<typeof NodeId>>;

export const NodeInfo = memoizeOne(() =>
  z.object({
    latency: z.number().int(),
    numInputs: z.number().int(),
    numOutputs: z.number().int(),
    parameters: z.record(z.lazy(ParameterModel)),
    reports: z.record(z.lazy(ReportModel)),
  })
...
export const OscParameterConfig = memoizeOne(() =>
  z.object({
    address: z.string(),
...
export const PlayRegion = memoizeOne(() =>
  z.object({
    end: z.number().int(),
    looping: z.boolean(),
    start: z.number().int(),
...
export const PlayStateReportTrigger = memoizeOne(() =>
  z.object({
    equals: z.union([z.number(), z.null()]),
    greaterThan: z.union([z.number(), z.null()]),
    lessThan: z.union([z.number(), z.null()]),
    report: z.string(),
    then: z.lazy(InstancePlayStateTransition),
  })
);
export type PlayStateReportTrigger = z.infer<
  ReturnType<typeof PlayStateReportTrigger>
>;

export const RegisterOrUpdateInstanceRequest = memoizeOne(() =>
  z.object({
    driverConfig: z.lazy(InstanceDriverConfig),
    driverId: z.string(),
    id: z.string(),
    modelId: z.string(),
    playSpec: z.union([z.lazy(InstanceMediaSpec), z.null()]),
    powerSpec: z.union([z.lazy(InstancePowerSpec), z.null()]),
  })
);
export type RegisterOrUpdateInstanceRequest = z.infer<
  ReturnType<typeof RegisterOrUpdateInstanceRequest>
>;

export const RegisterOrUpdateInstanceResponse = memoizeOne(() =>
  z.literal("success")
);
export type RegisterOrUpdateInstanceResponse = z.infer<
  ReturnType<typeof RegisterOrUpdateInstanceResponse>
>;

export const RegisterUserRequest = memoizeOne(() =>
  z.object({ email: z.string(), id: z.string(), password: z.string() })
);
export type RegisterUserRequest = z.infer<
  ReturnType<typeof RegisterUserRequest>
>;

export const RegisterUserResponse = memoizeOne(() =>
  z.object({ id: z.string() })
);
export type RegisterUserResponse = z.infer<
  ReturnType<typeof RegisterUserResponse>
>;

export const Remap = memoizeOne(() =>
  z.discriminatedUnion("type", [
    z.object({ type: z.literal("linear"), values: z.array(z.number()) }),
    z.object({
...
export const ReportModel = memoizeOne(() =>
  z.object({
    channels: z.number().int(),
    metadata: z.record(z.any()),
    range: z.lazy(ValueRange),
...
export const Rescale = memoizeOne(() =>
  z.object({
...
export const SerialParameterConfig = memoizeOne(() =>
  z.object({
    clamp: z.union([z.lazy(Clamp), z.null()]),
...
export type SerialParameterConfig = z.infer<
  ReturnType<typeof SerialParameterConfig>
>;

export const SerialReportConfig = memoizeOne(() =>
  z.object({
    clamp: z.union([z.lazy(Clamp), z.null()]),
...
export const SerialReportMatcher = memoizeOne(() =>
  z.discriminatedUnion("type", [
    z.object({
      prefix: z.string(),
      skip: z.union([z.number().int(), z.null()]),
      take: z.union([z.number().int(), z.null()]),
      type: z.literal("stringPrefix"),
    }),
    z.object({ regex: z.string(), type: z.literal("matches") }),
  ])
);
export type SerialReportMatcher = z.infer<
  ReturnType<typeof SerialReportMatcher>
>;

export const SerialReportValueInterpretation = memoizeOne(() =>
  z.discriminatedUnion("type", [
    z.object({ type: z.literal("parseFloat") }),
    z.object({ format: z.string(), type: z.literal("parseDateTimeToSeconds") }),
...
export type SerialReportValueInterpretation = z.infer<
  ReturnType<typeof SerialReportValueInterpretation>
>;

export const SerialRequestTimer = memoizeOne(() =>
  z.object({ intervalMs: z.number().int(), line: z.string() })
);
...
export const SetTaskControlResponse = memoizeOne(() =>
  z.discriminatedUnion("type", [
...
export type SetTaskControlResponse = z.infer<
  ReturnType<typeof SetTaskControlResponse>
>;

export const SetTaskGraphResponse = memoizeOne(() =>
  z.discriminatedUnion("type", [
    z.object({ type: z.literal("success") }),
    z.object({ type: z.literal("notFound") }),
  ])
);
export type SetTaskGraphResponse = z.infer<
  ReturnType<typeof SetTaskGraphResponse>
>;

export const SetTaskInstancesResponse = memoizeOne(() =>
  z.discriminatedUnion("type", [
    z.object({ type: z.literal("success") }),
    z.object({ type: z.literal("notFound") }),
    z.object({ type: z.literal("failure") }),
...
export type SetTaskInstancesResponse = z.infer<
  ReturnType<typeof SetTaskInstancesResponse>
>;

export const SetTaskSetting = memoizeOne(() =>
  z.object({
    channel: z.number().int(),
    node: z.lazy(NodeId),
    setting: z.string(),
...
export type SetTaskSetting = z.infer<ReturnType<typeof SetTaskSetting>>;

export const SetTaskSettingsResponse = memoizeOne(() =>
  z.discriminatedUnion("type", [
    z.object({ type: z.literal("success") }),
    z.object({ type: z.literal("notFound") }),
    z.object({ type: z.literal("failure") }),
...
export type SetTaskSettingsResponse = z.infer<
  ReturnType<typeof SetTaskSettingsResponse>
>;

export const SetTaskTimeRequest = memoizeOne(() =>
  z.object({ from: z.coerce.date(), to: z.coerce.date() })
);
export type SetTaskTimeRequest = z.infer<ReturnType<typeof SetTaskTimeRequest>>;

export const SetTaskTimeResponse = memoizeOne(() =>
  z.discriminatedUnion("type", [
    z.object({ type: z.literal("success") }),
    z.object({ type: z.literal("notFound") }),
    z.object({ type: z.literal("failure") }),
...
export type SetTaskTimeResponse = z.infer<
  ReturnType<typeof SetTaskTimeResponse>
>;

export const SinkSpec = memoizeOne(() =>
  z.object({
    inputs: z.array(z.array(z.lazy(OutputId))),
    sampleRate: z.number().int(),
  })
...
export const TaskEvent = memoizeOne(() =>
  z.object({
    instanceEvents: z.array(z.lazy(InstanceDriverEvent)),
    playId: z.union([z.string(), z.null()]),
    playerEvents: z.array(z.lazy(GraphPlayerEvent)),
  })
);
...
export type UsbHidParameterConfig = z.infer<
  ReturnType<typeof UsbHidParameterConfig>
>;

export const UsbHidParameterPage = memoizeOne(() =>
  z.object({
...
export type UsbHidParameterPage = z.infer<
  ReturnType<typeof UsbHidParameterPage>
>;

export const UsbHidReportConfig = memoizeOne(() =>
  z.object({
    packing: z.lazy(ValuePacking),
    page: z.number().int(),
    position: z.lazy(BinaryPosition),
...
export const ValueRange = memoizeOne(() =>
  z.discriminatedUnion("type", [
    ...
    z.object({ type: z.literal("list"), values: z.array(z.number()) }),
  ])
);
