...
import { InstanceParameters, DeviceReportsType, ParameterId } from '@audiocloud/api'
...
const LiveControlPanel: React.FC<Props> = ({ device_id, liveControlEnabled, playState, reports }) => {

  if (!device_id) return <div>No device found.</div>

  const [channelIds, setChannelIds] = useState<string[]>(clonedeep(defaultStates[device_id].channel_ids))
  const [parameters, setParameters] = useState<InstanceParameters>(clonedeep(defaultStates[device_id].parameters))
  const [wet, setWet] = useState(defaultStates[device_id].wet)
  ...
  const channelParameterHandler = debounce((value: string | number | boolean, channel: number, parameter: string, conversionRules: ConversionRules) => {
    ...
    if (parameters['link'] && parameters['link'][0] && !instancesWithoutExtractedChannelComponents.find(item => item === device_id)) {
  ...
  //     setInstanceParameters(device_id, changes)
  //   } else {
  ...
  return (
    <div className='m-4 border'>
      ...
      <div className='px-2 pb-4'>
        {/* { device_id === 'btrmkr_ml_1' &&          <Btrmkr_ML_Faceplate        parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'distopik_1176_1' &&      <D1176_ADG_Faceplate        parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'distopik_adu_1' &&       <DADU_Faceplate             parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'distopik_bwl_1' &&       <DBWL_Faceplate             parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'distopik_eqp1_1' &&      <DEQP1_Faceplate            parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'distopik_fc670_1' &&     <DFC670_Faceplate           parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'distopik_la2a_1' &&      <DLA2A_Faceplate            parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'distopik_meq_1' &&       <DMEQ_Faceplate             parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'distopik_vca_1' &&       <DVCA_Faceplate             parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'elysia_karacter_1' &&    <Elysia_karacter_Faceplate  parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'elysia_museq_1' &&       <Elysia_museq_Faceplate     parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'elysia_nvelope_1' &&     <Elysia_nvelope_Faceplate   parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'elysia_xfilter_1' &&     <Elysia_xfilter_Faceplate   parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'elysia_xpressor_1' &&    <Elysia_xpressor_Faceplate  parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'gyraf_g24_1' &&          <Gyraf_G24_Faceplate        parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'tierra_gravity_1' &&     <Tierra_Gravity_Faceplate   parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> }
        { device_id === 'neve_1084_1' &&          <Neve_1084_Faceplate        parameters={parameters} channelIds={channelIds} wet={wet} reports={reports} webSocketDefaultParametersSetter={webSocketDefaultParametersSetter} channelParameterHandler={channelParameterHandler} instanceParameterHandler={instanceParameterHandler} interfaceParameterHandler={interfaceParameterHandler} /> } */}
      </div>
