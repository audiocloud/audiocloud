...
const MediaConfigModal: React.FC<Props> = ({ originalConfig }) => {

  const [code, setCode] = useState(originalConfig)
  ...
  return (
    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Media Config Editor</DialogTitle>
        </DialogHeader>
        <CodeMirror
          theme={vscodeDark}
          value={code}
        ...
        <div className='pt-3 flex justify-center items-center gap-4'>
          ...
          <Button
            ...
            size='default'
            className='flex justify-center items-center gap-2'
            onClick={() => setCode(originalConfig)}
            disabled={originalConfig === code}
          >
