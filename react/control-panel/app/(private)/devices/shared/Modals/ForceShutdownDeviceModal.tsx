...
const ForceShutdownDeviceModal: React.FC<Props> = ({ isOpen, setOpen, device_id, handlePower }) => {
    ...
    <Dialog open={isOpen} onOpenChange={(e) => setOpen(e)} >
      <DialogContent>
        ...
        <DialogDescription className='text-base'>
          Are you sure you want to force shutdown <span className='font-semibold'>{ device_id }</span>?
        </DialogDescription>
...
export default ForceShutdownDeviceModal
