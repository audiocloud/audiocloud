...
const EndMaintenanceModal: React.FC<Props> = ({ isOpen, setOpen, device_id }) => {
    ...
    <Dialog open={isOpen} onOpenChange={(e) => setOpen(e)} >
      <DialogContent>
        ...
        <DialogDescription className='text-base'>
          Are you sure you want end the maintenance of <span className='font-semibold'>{ device_id }</span>?
        </DialogDescription>
