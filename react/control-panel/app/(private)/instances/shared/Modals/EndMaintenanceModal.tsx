...
const EndMaintenanceModal: React.FC<Props> = ({ isOpen, setOpen, instance_id }) => {
    ...
    <Dialog open={isOpen} onOpenChange={(e) => setOpen(e)} >
      <DialogContent>
        ...
        <DialogDescription className='text-base'>
          Are you sure you want end the maintenance of <span className='font-semibold'>{ instance_id }</span>?
        </DialogDescription>
