...
const NewMaintenance: React.FC<Props> = ({ instance_id, open, setOpen }) => {
                ...
                <div className="mb-10">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:text-left">
                    <div className="mt-2 text-sm text-gray-500 flex flex-col gap-4">
                      ...
                      <div>
                        <label htmlFor='instance-id' className='text-xs'>Instance ID</label>
                        <div id='instance-id' className='text-gray-800 font-medium text-lg'>{ instance_id }</div>
                      </div>
