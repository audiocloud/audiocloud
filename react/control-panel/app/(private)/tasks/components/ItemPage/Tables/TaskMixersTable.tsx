...
import TaskMixerActions from '../TaskMixerActions'
import { TaskMixer } from '@/types'

type Props = {
  mixers: TaskMixer[]
}

const TaskMixersTable: React.FC<Props> = ({ mixers }) => {
  return (
    <>
      ...
      <div className="sm:hidden">
        ...
        <div className="px-4 sm:px-6 pt-3 border-t border-gray-200 flex justify-between">
          <h2 className="text-sm font-medium text-gray-900">Mixer ID</h2>
        ...
        <ul role="list" className="mt-3 divide-y divide-gray-100 border-t border-gray-200">
          { mixers.map((mixer) => (
            <li key={mixer.id} className='hover:bg-gray-100'>
        ...
        <div className="inline-block min-w-full border-y border-gray-200 align-middle">
          <table className="min-w-full">
            <thead>
              <tr>
                ...
                <th scope="col" className="border-b border-gray-200 bg-gray-50 px-5 py-3 text-left text-sm font-semibold text-gray-900 whitespace-nowrap">
                  <span className="lg:pl-2">Mixer ID</span>
                </th>
            ...
            <tbody className="divide-y divide-gray-100 bg-white">
              { mixers.map((mixer) => (
                <tr key={mixer.id} className='hover:bg-gray-100'>
...
export default TaskMixersTable