...
pub const EQL_TOGGLE_VALUES: [ModelValueOption; 2] = [ModelValueOption::Single(
ModelValue::Bool(false)),ModelValueOption::Single(
ModelValue::Bool(true)),];
pub const HIGH_FREQ_NAME: &str = "high_freq";
pub const HIGH_FREQ_VALUES: [ModelValueOption; 6] = [ModelValueOption::Single(
ModelValue::Bool(false)),ModelValueOption::Single(
ModelValue::Number(8000_f64)),ModelValueOption::Single(
ModelValue::Number(10000_f64)),ModelValueOption::Single(
ModelValue::Number(12000_f64)),ModelValueOption::Single(
ModelValue::Number(16000_f64)),ModelValueOption::Single(
ModelValue::Number(20000_f64)),];
pub const HIGH_GAIN_NAME: &str = "high_gain";
pub const HIGH_GAIN_VALUES: [ModelValueOption; 1] = [ModelValueOption::Range(
ModelValue::Number(-16_f64), 
ModelValue::Number(16_f64)),];
pub const HIGH_MID_FREQ_NAME: &str = "high_mid_freq";
pub const HIGH_MID_FREQ_VALUES: [ModelValueOption; 12] = [ModelValueOption::Single(
ModelValue::Bool(false)),ModelValueOption::Single(
ModelValue::Number(360_f64)),ModelValueOption::Single(
ModelValue::Number(480_f64)),ModelValueOption::Single(
ModelValue::Number(720_f64)),ModelValueOption::Single(
ModelValue::Number(1600_f64)),ModelValueOption::Single(
ModelValue::Number(2400_f64)),ModelValueOption::Single(
ModelValue::Number(3200_f64)),ModelValueOption::Single(
ModelValue::Number(3900_f64)),ModelValueOption::Single(
ModelValue::Number(4800_f64)),ModelValueOption::Single(
ModelValue::Number(6400_f64)),ModelValueOption::Single(
ModelValue::Number(7200_f64)),ModelValueOption::Single(
ModelValue::Number(8400_f64)),];
pub const HIGH_MID_GAIN_NAME: &str = "high_mid_gain";
pub const HIGH_MID_GAIN_VALUES: [ModelValueOption; 1] = [ModelValueOption::Range(
ModelValue::Number(-12_f64), 
ModelValue::Number(12_f64)),];
pub const HIGH_MID_WIDTH_NAME: &str = "high_mid_width";
pub const HIGH_MID_WIDTH_VALUES: [ModelValueOption; 2] = [ModelValueOption::Single(
ModelValue::Bool(false)),ModelValueOption::Single(
ModelValue::Bool(true)),];
pub const HIGH_PASS_FILTER_NAME: &str = "high_pass_filter";
pub const HIGH_PASS_FILTER_VALUES: [ModelValueOption; 6] = [ModelValueOption::Single(
ModelValue::Bool(false)),ModelValueOption::Single(
ModelValue::Number(22_f64)),ModelValueOption::Single(
ModelValue::Number(45_f64)),ModelValueOption::Single(
ModelValue::Number(70_f64)),ModelValueOption::Single(
ModelValue::Number(160_f64)),ModelValueOption::Single(
ModelValue::Number(360_f64)),];
pub const INPUT_GAIN_NAME: &str = "input_gain";
pub const INPUT_GAIN_VALUES: [ModelValueOption; 8] = [ModelValueOption::Single(
ModelValue::Bool(false)),ModelValueOption::Single(
ModelValue::Number(-10_f64)),ModelValueOption::Single(
ModelValue::Number(-5_f64)),ModelValueOption::Single(
ModelValue::Number(0_f64)),ModelValueOption::Single(
ModelValue::Number(5_f64)),ModelValueOption::Single(
ModelValue::Number(10_f64)),ModelValueOption::Single(
ModelValue::Number(15_f64)),ModelValueOption::Single(
ModelValue::Number(20_f64)),];
pub const LOW_FREQ_NAME: &str = "low_freq";
pub const LOW_FREQ_VALUES: [ModelValueOption; 6] = [ModelValueOption::Single(
ModelValue::Bool(false)),ModelValueOption::Single(
ModelValue::Number(20_f64)),ModelValueOption::Single(
ModelValue::Number(35_f64)),ModelValueOption::Single(
ModelValue::Number(60_f64)),ModelValueOption::Single(
ModelValue::Number(110_f64)),ModelValueOption::Single(
ModelValue::Number(220_f64)),];
pub const LOW_GAIN_NAME: &str = "low_gain";
pub const LOW_GAIN_VALUES: [ModelValueOption; 1] = [ModelValueOption::Range(
ModelValue::Number(-16_f64), 
ModelValue::Number(16_f64)),];
pub const LOW_MID_FREQ_NAME: &str = "low_mid_freq";
pub const LOW_MID_FREQ_VALUES: [ModelValueOption; 12] = [ModelValueOption::Single(
ModelValue::Bool(false)),ModelValueOption::Single(
ModelValue::Number(120_f64)),ModelValueOption::Single(
ModelValue::Number(180_f64)),ModelValueOption::Single(
ModelValue::Number(240_f64)),ModelValueOption::Single(
ModelValue::Number(360_f64)),ModelValueOption::Single(
ModelValue::Number(480_f64)),ModelValueOption::Single(
ModelValue::Number(720_f64)),ModelValueOption::Single(
ModelValue::Number(1600_f64)),ModelValueOption::Single(
...
ModelValue::Number(3200_f64)),ModelValueOption::Single(
ModelValue::Number(4800_f64)),ModelValueOption::Single(
ModelValue::Number(7200_f64)),];
pub const LOW_MID_GAIN_NAME: &str = "low_mid_gain";
pub const LOW_MID_GAIN_VALUES: [ModelValueOption; 1] = [ModelValueOption::Range(
ModelValue::Number(-12_f64), 
ModelValue::Number(12_f64)),];
pub const LOW_MID_WIDTH_NAME: &str = "low_mid_width";
pub const LOW_MID_WIDTH_VALUES: [ModelValueOption; 2] = [ModelValueOption::Single(
ModelValue::Bool(false)),ModelValueOption::Single(
ModelValue::Bool(true)),];
pub const OUTPUT_PAD_NAME: &str = "output_pad";
pub const OUTPUT_PAD_VALUES: [ModelValueOption; 3] = [ModelValueOption::Single(
ModelValue::Bool(false)),ModelValueOption::Single(
ModelValue::Number(-10_f64)),ModelValueOption::Single(
ModelValue::Number(-20_f64)),];
...
pub const BUS_ASSIGN_VALUES: [ModelValueOption; 3] = [ModelValueOption::Single(
ModelValue::Number(0_f64)),ModelValueOption::Single(
ModelValue::Number(1_f64)),ModelValueOption::Single(
ModelValue::Number(2_f64)),];
pub const INPUT_NAME: &str = "input";
pub const INPUT_VALUES: [ModelValueOption; 1] = [ModelValueOption::Range(
ModelValue::Number(-48_f64), 
ModelValue::Number(10_f64)),];
pub const PAN_NAME: &str = "pan";
pub const PAN_VALUES: [ModelValueOption; 1] = [ModelValueOption::Range(
ModelValue::Number(-1_f64), 
ModelValue::Number(1_f64)),];
...
pub const POWER_VALUES: [ModelValueOption; 2] = [ModelValueOption::Single(
ModelValue::Bool(false)),ModelValueOption::Single(
ModelValue::Bool(true)),];
