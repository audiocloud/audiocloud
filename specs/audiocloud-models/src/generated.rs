...
pub mod distopik {
    ...
    pub mod dual1084 {
        ...
        pub const EQL_TOGGLE_VALUES: [ModelValueOption; 2] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Single(/*
                                                                                            * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                            */
        ...
        pub const HIGH_FREQ_VALUES: [ModelValueOption; 6] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Single(/*
                                                                                           * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                 ...
                                                                 ModelValueOption::Single(/*
                                                                                           * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                           */
                                                                                          ModelValue::Number(8000_f64)),
                                                                 ModelValueOption::Single(/*
                                                                                           * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                           */
                                                                                          ModelValue::Number(10000_f64)),
                                                                 ModelValueOption::Single(/*
                                                                                           * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                           */
                                                                                          ModelValue::Number(12000_f64)),
                                                                 ModelValueOption::Single(/*
                                                                                           * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                           */
                                                                                          ModelValue::Number(16000_f64)),
                                                                 ModelValueOption::Single(/*
                                                                                           * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                           */
        ...
        pub const HIGH_MID_FREQ_VALUES: [ModelValueOption; 12] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Single(/*
                                                                                                * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                      ...
                                                                      ModelValueOption::Single(/*
                                                                                                * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                */
                                                                                               ModelValue::Number(480_f64)),
                                                                      ModelValueOption::Single(/*
                                                                                                * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                */
                                                                                               ModelValue::Number(720_f64)),
                                                                      ModelValueOption::Single(/*
                                                                                                * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                */
                                                                                               ModelValue::Number(1600_f64)),
                                                                      ModelValueOption::Single(/*
                                                                                                * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                */
                                                                                               ModelValue::Number(2400_f64)),
                                                                      ModelValueOption::Single(/*
                                                                                                * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                */
                                                                                               ModelValue::Number(3200_f64)),
                                                                      ModelValueOption::Single(/*
                                                                                                * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                */
                                                                                               ModelValue::Number(3900_f64)),
                                                                      ModelValueOption::Single(/*
                                                                                                * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                */
                                                                                               ModelValue::Number(4800_f64)),
                                                                      ModelValueOption::Single(/*
                                                                                                * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                */
                                                                                               ModelValue::Number(6400_f64)),
                                                                      ModelValueOption::Single(/*
                                                                                                * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                */
        ...
        pub const HIGH_MID_WIDTH_VALUES: [ModelValueOption; 2] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Single(/*
                                                                                                * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
        ...
        pub const HIGH_PASS_FILTER_VALUES: [ModelValueOption; 6] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Single(/*
                                                                                                  * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                        ...
                                                                        ModelValueOption::Single(/*
                                                                                                  * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                  */
                                                                                                 ModelValue::Number(22_f64)),
                                                                        ModelValueOption::Single(/*
                                                                                                  * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                  */
                                                                                                 ModelValue::Number(45_f64)),
                                                                        ModelValueOption::Single(/*
                                                                                                  * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                  */
                                                                                                 ModelValue::Number(70_f64)),
                                                                        ModelValueOption::Single(/*
                                                                                                  * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                  */
                                                                                                 ModelValue::Number(160_f64)),
                                                                        ModelValueOption::Single(/*
                                                                                                  * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                                  */
                                                                                                 ModelValue::Number(360_f64))];
        pub const INPUT_GAIN_NAME: &str = "input_gain";
        pub const INPUT_GAIN_VALUES: [ModelValueOption; 8] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Single(/*
                                                                                            * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                  ...
                                                                  ModelValueOption::Single(/*
                                                                                            * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                            */
                                                                                           ModelValue::Number(-5_f64)),
                                                                  ModelValueOption::Single(/*
                                                                                            * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                            */
                                                                                           ModelValue::Number(0_f64)),
                                                                  ModelValueOption::Single(/*
                                                                                            * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                            */
                                                                                           ModelValue::Number(5_f64)),
                                                                  ...
                                                                  ModelValueOption::Single(/*
                                                                                            * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                            */
                                                                                           ModelValue::Number(15_f64)),
                                                                  ModelValueOption::Single(/*
                                                                                            * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                            */
                                                                                           ModelValue::Number(20_f64))];
        pub const LOW_FREQ_NAME: &str = "low_freq";
        pub const LOW_FREQ_VALUES: [ModelValueOption; 6] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Single(/*
                                                                                          * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                ...
                                                                ModelValueOption::Single(/*
                                                                                          * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                          */
                                                                                         ModelValue::Number(35_f64)),
                                                                ModelValueOption::Single(/*
                                                                                          * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                          */
                                                                                         ModelValue::Number(60_f64)),
                                                                ModelValueOption::Single(/*
                                                                                          * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                          */
                                                                                         ModelValue::Number(110_f64)),
                                                                ModelValueOption::Single(/*
                                                                                          * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                          */
        ...
        pub const LOW_MID_FREQ_VALUES: [ModelValueOption; 12] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Single(/*
                                                                                               * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                     ...
                                                                     ModelValueOption::Single(/*
                                                                                               * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                               */
                                                                                              ModelValue::Number(120_f64)),
                                                                     ModelValueOption::Single(/*
                                                                                               * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                               */
                                                                                              ModelValue::Number(180_f64)),
                                                                     ModelValueOption::Single(/*
                                                                                               * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                               */
                                                                                              ModelValue::Number(240_f64)),
                                                                     ModelValueOption::Single(/*
                                                                                               * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
                                                                                               */
                                                                                              ModelValue::Number(360_f64)),
        ...
        pub const LOW_MID_WIDTH_VALUES: [ModelValueOption; 2] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Single(/*
                                                                                               * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
        ...
        pub const OUTPUT_PAD_VALUES: [ModelValueOption; 3] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Single(/*
                                                                                            * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
    ...
    pub mod summatra {
        ...
        pub const BUS_ASSIGN_VALUES: [ModelValueOption; 3] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Single(/*
                                                                                            * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
        ...
        pub const INPUT_VALUES: [ModelValueOption; 1] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Range(/*
                                                                                      * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
        ...
        pub const PAN_VALUES: [ModelValueOption; 1] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Range(/*
                                                                                    * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
...
pub mod netio {
    ...
    pub mod power_pdu_4c {
        ...
        pub const POWER_VALUES: [ModelValueOption; 2] = /*
             * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
             */
            [ModelValueOption::Single(/*
                                                                                       * Copyright (c) Audio Cloud, 2022. This code is licensed under MIT license (see LICENSE for details)
